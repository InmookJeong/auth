...
public class UpdateTermsTest {
	...
	void testTermsDtoIsNullWithLocaleKoKr() throws Exception {
		...
		String statusCode = "ERR-TMS-UPD-001";
		String status = "UPDATE ERROR";
		String resultMessage = "이용약관 정보가 비어있거나 전달되지 않았습니다. 수정하실 이용약관 정보를 다시 확인해주세요.";
	...
	void testTermsDtoIsNullWithLocaleEnUs() throws Exception {
		...
		String statusCode = "ERR-TMS-UPD-001";
		String status = "UPDATE ERROR";
		String resultMessage = "The Terms of Use information is empty or not provided. Please review the Terms of Use information you wish to modify.";
